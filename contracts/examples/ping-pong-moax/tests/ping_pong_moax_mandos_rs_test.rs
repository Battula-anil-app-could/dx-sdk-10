...
fn ping_pong_call_ping_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/ping-pong-call-ping.scen.json", &contract_map());
}
...
fn ping_pong_call_pong_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/ping-pong-call-pong.scen.json", &contract_map());
}

#[test]
fn ping_pong_call_pong_all_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/ping-pong-call-pong-all.scen.json", &contract_map());
}
...
fn ping_pong_init_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/ping-pong-init.scen.json", &contract_map());
}
