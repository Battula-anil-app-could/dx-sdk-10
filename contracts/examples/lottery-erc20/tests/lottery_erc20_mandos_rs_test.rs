...
#[test]
fn buy_ticket_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/buy-ticket.scen.json", &contract_map());
}
...
fn buy_ticket_all_options_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/buy-ticket-all-options.scen.json", &contract_map());
}
...
fn buy_ticket_same_account_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/buy-ticket-same-account.scen.json", &contract_map());
}
...
fn buy_ticket_wrong_fee_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/buy-ticket-wrong-fee.scen.json", &contract_map());
}
...
fn determine_winner_early_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/determine-winner-early.scen.json", &contract_map());
}
...
#[test]
fn lottery_init_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/lottery-init.scen.json", &contract_map());
}
...
fn start_fixed_deadline_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/start-fixed-deadline.scen.json", &contract_map());
}

#[test]
fn start_limited_tickets_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/start-limited-tickets.scen.json", &contract_map());
}
...
fn start_second_lottery_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/start-second-lottery.scen.json", &contract_map());
}

#[test]
fn start_with_all_options_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/start-with-all-options.scen.json", &contract_map());
}

#[test]
fn start_with_no_options_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/start-with-no-options.scen.json", &contract_map());
}
