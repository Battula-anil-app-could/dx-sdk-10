...
#[test]
fn deploy_test_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/deploy.scen.json", &contract_map());
}
...
fn create_token_fungible_test_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/create_token_fungible.scen.json", &contract_map());
}
...
fn transfer_fungible_ok_test_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/transfer_fungible_ok.scen.json", &contract_map());
}
...
fn transfer_non_fungible_ok_test_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/transfer_non_fungible_ok.scen.json", &contract_map());
}

#[test]
fn batch_transfer_fungible_test_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/batch_transfer_fungible.scen.json", &contract_map());
}
...
fn transfer_fungible_ok_to_sc_test_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/transfer_fungible_ok_to_sc.scen.json", &contract_map());
}

#[test]
fn transfer_non_fungible_ok_to_sc_test_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/transfer_non_fungible_ok_to_sc.scen.json", &contract_map());
}


#[test]
fn batch_transfer_fungible_to_sc_test_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/batch_transfer_fungible_to_sc.scen.json", &contract_map());
}

#[test]
fn batch_transfer_non_fungible_to_sc_test_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/batch_transfer_non_fungible_to_sc.scen.json", &contract_map());
}

#[test]
fn batch_transfer_both_types_to_sc_test_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/batch_transfer_both_types_to_sc.scen.json", &contract_map());
}
*/
...
fn mint_fungible_test_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/mint_fungible.scen.json", &contract_map());
}

#[test]
fn mint_non_fungible_test_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/mint_non_fungible.scen.json", &contract_map());
}

#[test]
fn mint_not_creator_test_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/mint_not_creator.scen.json", &contract_map());
}
...
fn burn_fungible_test_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/burn_fungible.scen.json", &contract_map());
}

#[test]
fn burn_non_fungible_test_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/burn_non_fungible.scen.json", &contract_map());
}
