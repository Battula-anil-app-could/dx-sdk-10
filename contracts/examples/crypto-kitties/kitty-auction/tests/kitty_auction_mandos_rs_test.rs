...
fn bid_second_max_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/bid_second_max.scen.json", &contract_map());
}

#[test]
fn bid_second_ok_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/bid_second_ok.scen.json", &contract_map());
}

#[test]
fn bid_second_too_low_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/bid_second_too_low.scen.json", &contract_map());
}

#[test]
fn bid_siring_auction_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/bid_siring_auction.scen.json", &contract_map());
}
...
fn create_sale_auction_ok_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/create_sale_auction_ok.scen.json", &contract_map());
}
...
fn create_siring_auction_ok_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/create_siring_auction_ok.scen.json", &contract_map());
}

#[test]
fn end_auction_no_bids_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/end_auction_no_bids.scen.json", &contract_map());
}
...
fn end_siring_auction_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/end_siring_auction.scen.json", &contract_map());
}
