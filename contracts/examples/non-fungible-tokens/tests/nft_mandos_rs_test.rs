...
fn nft_approve_ok_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/nft-approve-ok.scen.json", &contract_map());
}

#[test]
fn nft_init_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/nft-init.scen.json", &contract_map());
}
...
fn nft_revoke_non_approved_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/nft-revoke-non-approved.scen.json", &contract_map());
}

#[test]
fn nft_revoke_ok_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/nft-revoke-ok.scen.json", &contract_map());
}
...
fn nft_transfer_ok_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/nft-transfer-ok.scen.json", &contract_map());
}
...
fn nft_transfer_token_ok_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/nft-transfer-token-ok.scen.json", &contract_map());
}
