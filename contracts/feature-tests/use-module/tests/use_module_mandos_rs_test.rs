...
fn use_module_dns_register_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/use_module_dns_register.scen.json", &contract_map());
}

#[test]
fn use_module_features_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/use_module_features.scen.json", &contract_map());
}

#[test]
fn use_module_internal_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/use_module_internal.scen.json", &contract_map());
}

#[test]
fn use_module_pause_rs() {
	dharitri_wasm_debug::mandos_rs("mandos/use_module_pause.scen.json", &contract_map());
}
